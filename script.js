...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Mobile carousels functionality
    if (window.innerWidth <= 768) {
        // Initialize skill carousel
        initializeCarousel('.skills-container', '.skill-row', '.skills-dots');
        
        // Initialize experience carousel
        initializeCarousel('.experience-grid', '.timeline-item', '.experience-dots');
        
        // Initialize projects carousel
        initializeCarousel('.projects-grid', '.project-card', '.projects-dots');
    }
    
    // Generic carousel initialization function
    function initializeCarousel(containerSelector, itemSelector, dotsContainerSelector) {
        ...
        function scrollToItem(index) {
            ...
            // Update dots
            document.querySelectorAll(`${dotsContainerSelector} .carousel-dot`).forEach((dot, i) => {
        ...
        container.addEventListener('scroll', () => {
            ...
            // Update dots
            document.querySelectorAll(`${dotsContainerSelector} .carousel-dot`).forEach((dot, i) => {
                dot.classList.toggle('active', i === closestItem);
            });
        });
        ...
        const endDrag = () => {
            ...
            // Snap to closest item after drag ends
            const containerRect = container.getBoundingClientRect();
            let closestItem = 0;
            let minDistance = Infinity;
